...
API_ID = int(environ['28341884'])
API_HASH = environ['ca0c9295ce3ec910fd6f49e99970d9a8']
BOT_TOKEN = environ['5910173288:AAHez9zuWzfZMyg3uKcfEA-gyJ2T4kgaY-8']
...
auth_channel = environ.get('-1001914979296')
...
START_MESSAGE = environ.get('START_MESSAGE', "👋 𝙃𝙚𝙮,{user}\n 𝙃𝙤𝙬 𝘼𝙧𝙚 𝙔𝙤𝙪 𝙄𝙢 𝘼𝙙𝙢𝙞𝙣 𝙊𝙛 𝙈𝙖𝙡𝙖𝙮𝙖𝙡𝙞 𝙁𝙧𝙚𝙖𝙠𝙨 𝙂𝙧𝙤𝙪𝙥...")
...
WELCOM_TEXT = environ.get("WELCOM_TEXT", "👋 𝙃𝙀𝙔, {user} ❤️ 𝙒𝙀𝙇𝘾𝙊𝙈𝙀 𝙏𝙊 {chat} your friends 💞 Let the group power be ❤️‍🔥")
...
SHORT_API = environ.get("77b8dcb0581bea722a05242ab3324794396eafba")

# Others
IMDB_DELET_TIME = int(environ.get('IMDB_DELET_TIME', "300"))
LOG_CHANNEL = int(environ.get('LOG_CHANNEL',"-1001843928263"))
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'IV_Movies_Discussion')
...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1001800483891')).split()]
